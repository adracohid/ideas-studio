...
public class GDrive {
	...
	public static boolean isConnected(String username) {
		boolean res=false;
		java.io.File file=new java.io.File("ideas-repo/"+username+"/StoredCredential");
		if(file.exists()) {
			res=true;
		}
		return res;
	...
	public static boolean logout(String username) {
		...
		java.io.File token=new java.io.File("ideas-repo/"+username+"/StoredCredential");
		if(token.exists()) {
			token.delete();
			res=true;
		}
